...
class Markdown {
    ...
    private function parseByPerlScript($markdown){
...
class CMarkdownParser extends \MarkdownExtra_Parser
{
    ...
    {
        return dirname(__FILE__).'/../vendor/TextHighlighter/highlight.css';
    }
    ...
    protected function highlightCodeBlock($codeblock)
    {
        if(($tag=$this->getHighlightTag($codeblock))!==null && ($highlighter=$this->createHighLighter($tag)))
        {
            ...
            return "<pre>".htmlspecialchars($codeblock)."</pre>";
    }
    ...
    protected function createHighLighter($options)
    {
        ...
        {
            require_once(dirname(__FILE__).'/../vendor/TextHighlighter/Text/Highlighter.php');
            require_once(dirname(__FILE__).'/../vendor/TextHighlighter/Text/Highlighter/Renderer/Html.php');
        }
