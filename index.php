...
class AjaxRequest extends ModleBase{
    private $url;
    private $params;
    private $method;
    private $id;
...
class AjaxResponse extends ModleBase{
    private $id;
    private $body;
    private $format;
    private $cache;
...
class AjaxHistory extends ModleBase{
    private $id;
    private $request_id;
    private $_request;
    private $response_id;
...
class AjaxGroup extends ModleBase{
    private $id;
    private $name;
    private $_urls;
...
class AjaxExample extends ModleBase{
    private $id;
    private $group_id;
    private $_group;
    private $name;
